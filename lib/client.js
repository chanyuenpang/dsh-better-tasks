window.__ModuleLoader__.load({
  ...
  factory: requireModule => {
    ...
    const TASK_SETTINGS_NAMESPACE = 'better-tasks-ui'
    const TASK_DETAIL_FONT_MIN = 11
    const TASK_DETAIL_FONT_MAX = 16
    const TASK_COLUMN_LAYOUTS = Object.freeze(['auto', 'single', 'double'])
    const DEFAULT_TASK_PREFERENCES = Object.freeze({
      detailFontSize: 13,
    ...
    function decodeTaskPreferences(value) {
    ...
    function createTaskPreferencesStore() {
    ...
    function isProjectionExpanded(value, key, defaultExpanded) {
